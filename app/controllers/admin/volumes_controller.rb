class Admin::VolumesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @volume.save
        format.html {redirect_to edit_admin_volume_path(@volume), notice: 'Volume was successfully created.'}
  ...
  def update
    respond_to do |format|
      ...
      if @volume.update(volume_params)
        format.html {redirect_to edit_admin_volume_path(@volume), notice: 'Volume was successfully updated.'}
  ...
  def destroy
    @volume.destroy
    respond_to do |format|
      format.html {redirect_to admin_volumes_url, notice: 'Volume was successfully destroyed.'}
