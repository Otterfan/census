class Admin::TextsController < ApplicationController
  ...
  def update
    respond_to do |format|
      ...
      if @text.update(text_params)
        format.html { redirect_to edit_admin_text_path(@text), notice: 'Text was successfully updated.' }
        format.json { render :show, status: :ok, location: @text }
      else
        format.html { redirect_to edit_admin_text_path(@text), notice: @text.errors }
        format.json { render json: @text.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    ...
    @text.destroy
    respond_to do |format|
      format.html { redirect_to admin_texts_url, notice: 'Text was successfully destroyed.' }
