class Admin::JournalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @journal.save
        format.html { redirect_to edit_admin_journal_path(@journal), notice: 'Journal was successfully created.' }
  ...
  def update
    respond_to do |format|
      ...
      if @journal.update(journal_params)
        format.html { redirect_to edit_admin_journal_path(@journal), notice: 'Journal was successfully updated.' }
